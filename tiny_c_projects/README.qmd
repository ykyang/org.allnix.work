...
Open with "codium" from a Linux terminal.
...
# 4 Caesarean cipher
* Caesarean cipher is not secure
* streaming I/O
* I/O filter
* rotating character
* shifting character
* hex input filter
* NATO phonetic filter
* filter to find words
...
// Listing 4.2, page 53
// buffering.c
// No prompt due to the buffer setting, but still accepts input.
```
