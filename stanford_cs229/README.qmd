...
::: {.callout-note title="Class material" icon=false collapse=true}
...
::: {.callout-note title="Class timeline" icon=false collapse=true}
...
* Linear function $\rightarrow$ linear regression
...
* $x_2$, No. of bedrooms  
* $\theta_j$, parameter of feature $x_j$
